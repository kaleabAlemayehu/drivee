	...
	<div class="h-screen w-full flex w-hidden">
		<div
			...
			<div
				...
				<div class="px-6 py-3 bg-white text-black rounded-md flex cursor-pointer">
		...
		<div class="h-full bg-white w-full py-8">
			<div class="w-3/5 mx-auto">
				...
				<div class="w-3/4 border-[1px] border-transparent border-t-gray-100 flex flex-col py-4">
					...
					<div class="flex items-center justify-start mt-5 mb-3">
						...
						<div class="lable-agree inline-block">
							I agree to the
							<span class="capitalize underline cursor-pointer">terms and
								privacy policy.</span>
						</div>
					</div>
