...
<template>
  <div
    ref="wrapper"
    class="w-full flex items-center z-9999 py-2 fixed top-0 right-0 left-0 transition-all duration-300 bg-gray-950 bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-10 text-white"
  >
    <div
