...
<template>
	<div class="h-screen bg-[url(/bgworld.png)] bg-cover bg-center object-cover origin-center bg-no-repeat w-full">
		<div class="capitalize text-center text-5xl font-semibold pt-50 mb-20">
			Local services we provide
		</div>
		<div class="flex justify-center items-center relative -top-25/100 w-5/6 mx-auto h-full">
			<div
				...
				<div class="hover:shadow-lg transition-shadow bg-white size-20 duration-200 cursor-pointer rounded-full justify-center items-center focus:scale-110 flex"
					@click="handleLeft()">
			...
			<div
				...
				<div v-for="(el, i) in visibleItems" :key="el"
