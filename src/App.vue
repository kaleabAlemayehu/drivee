...
<template>
  <router-view name="NavBar" class="" />
  <router-view></router-view>
  <div
    class="fixed flex justify-center px-4 py-2 items-center size-12 bg-white shadow-lg bottom-10 left-10 z-10"
  >
